        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { icon: <Database size={14} className="text-amber-400" />, title: 'Бэкап', desc: 'Копия вашего пространства — все данные и файлы — одним архивом, и восстановление из него же. Настройки → Бэкап' },
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { icon: <Database size={14} className="text-amber-400" />, title: 'Backup', desc: 'A copy of your workspace — all its data and files — as one archive, and the restore from it. Settings → Backup' },
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { icon: <Database size={14} className="text-amber-400" />, title: 'Бэкап', desc: 'Копія вашай прасторы — усе даныя і файлы — адным архівам, і аднаўленне з яго ж. Налады → Бэкап' },
